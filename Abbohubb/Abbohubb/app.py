...
# Flask app met expliciete static folder-configuratie
app = Flask(__name__, static_folder='static', static_url_path='/static')

# Secret key en configuraties
app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'jouw_geheime_sleutel')
...
def clear_comparison():
    response = jsonify({"message": "Comparison list cleared!"})
    response.set_cookie('comparison_ids', '', max_age=0)  # Verwijder de cookie
    return response
